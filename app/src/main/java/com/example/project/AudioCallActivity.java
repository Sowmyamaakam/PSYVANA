...
public class AudioCallActivity extends AppCompatActivity {
    ...
    private void uploadDoctorNotesPdf() {
        ...
        int x = 40, y = 60;
        canvas.drawText("Audio Consultation Notes", x, y, paint); y += 24;
